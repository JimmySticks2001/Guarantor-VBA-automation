...
#Next, open Avatar to the Guarantors/Payors form and don't click anything. 
#After starting the script from the workbook this script will read the macroGuarantors sheet in the workbook. 
# If there are any problems during this operation such as the workbook not being available to open, or the macroGuarantors sheet
